...
class UserConfigService:
    ...
    def create_user_config(
        ...
        try:
            ...
            existing = db.query(UserMonitoringConfig).filter(
                and_(
            ...
            if existing:
                self.logger.warning(f"Configuração '{config_name}' já existe para usuário {user_id}")
                return None
            ...
            self.logger.info(f"Configuração criada para usuário {user_id}: {len(symbols)} símbolos, {len(timeframes)} timeframes")
            return config
    ...
    def get_user_configs(self, user_id: int, active_only: bool = True) -> List[UserMonitoringConfig]:
    ...
    def update_user_symbols(self, user_id: int, symbols: List[str], config_name: str = "default") -> bool:
        ...
        try:
            ...
            config = db.query(UserMonitoringConfig).filter(
                and_(
                    UserMonitoringConfig.user_id == user_id,
                    UserMonitoringConfig.config_name == config_name,
            ...
            if not config:
                self.logger.warning(f"Configuração '{config_name}' não encontrada para usuário {user_id}")
                return False
    ...
    def update_user_timeframes(self, user_id: int, timeframes: List[str], config_name: str = "default") -> bool:
        ...
        try:
            ...
            self.logger.info(f"Timeframes atualizados para usuário {user_id}: {timeframes}")
            return True
    ...
    def update_user_rsi_config(
        ...
        try:
            ...
            old_config = config.indicators_config.get("RSI", {}) if config.indicators_config else {}
            ...
            self.logger.info(f"RSI atualizado para usuário {user_id}: {oversold}/{overbought}")
            return True
    ...
    def get_user_config_summary(self, user_id: int, config_name: str = "default") -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao obter resumo da configuração do usuário {user_id}: {e}")
            return None
    ...
    def delete_user_config(self, user_id: int, config_name: str) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Configuração '{config_name}' deletada para usuário {user_id}")
            return True
    ...
    def subscribe_user(
        ...
        try:
            ...
            existing = db.query(UserMonitoringConfig).filter(
                UserMonitoringConfig.chat_id == str(chat_id)
            ).first()
    ...
    def get_active_subscribers(self, chat_type: str = None) -> List[UserMonitoringConfig]:
    ...
    def increment_signals_received(self, chat_id: str) -> bool:
        ...
        try:
            ...
            self.logger.error(f"Erro ao incrementar contador de sinais para {chat_id}: {e}")
            return False
    ...
    def get_subscription_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            active_subscribers = db.query(UserMonitoringConfig).filter(
                UserMonitoringConfig.active == True
            ).count()
            
            # Estatísticas por tipo de chat
            private_chats = db.query(UserMonitoringConfig).filter(
                and_(
                    UserMonitoringConfig.active == True,
            ...
            groups = db.query(UserMonitoringConfig).filter(
                and_(
                    UserMonitoringConfig.active == True,
            ...
            total_signals_sent = db.query(UserMonitoringConfig).with_entities(
                db.func.sum(UserMonitoringConfig.signals_received)
            ).scalar() or 0
    ...
    def get_user_subscription_info(self, chat_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao obter informações de assinatura para {chat_id}: {e}")
            return None
    ...
    def cleanup_inactive_subscribers(self, days_inactive: int = 30) -> int:
        ...
        try:
            ...
            inactive_configs = db.query(UserMonitoringConfig).filter(
                and_(
                    UserMonitoringConfig.active == True,
            ...
            self.logger.info(f"Limpeza concluída: {count} assinantes inativos desativados")
            return count
